function createUnityInstance(e, t, r) {
  ...
  function i(e, t) {
    if ("symbolsUrl" != e) {
      ...
      n || (n = f.downloadProgress[e] = { started: !1, finished: !1, lengthComputable: !1, total: 0, loaded: 0 }),
        "object" != typeof t ||
      ...
      try {
        for (var o in v)
          if (v[o].hasUnityMarker(e)) {
            ...
            return (a.worker.callbacks[i] = r), void a.worker.postMessage({ id: i, compressed: e }, [e.buffer]);
          }
        r(e);
      } catch (e) {
        n(e);
      ...
      console.error(e),
        "string" == typeof e &&
          ...
          (e.toLowerCase().indexOf("mime") != -1
            ? n('HTTP Response Header "Content-Type" configured incorrectly on the server for file ' + f.codeUrl + ' , should be "application/wasm". Startup time performance will suffer.', "warning")
            : n(
  ...
  return new Promise(function (e, t) {
    f.SystemInfo.hasWebGL
      ? 1 == f.SystemInfo.hasWebGL
        ? t('Your browser does not support graphics API "WebGL 2" which is required for this content.')
        : f.SystemInfo.hasWasm
        ? (1 == f.SystemInfo.hasWebGL && f.print('Warning: Your browser does not support "WebGL 2" Graphics API, switching to "WebGL 1"'),
