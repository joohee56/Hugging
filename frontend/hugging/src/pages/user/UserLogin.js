...
function UserLogin() {
    ...
    const REDIRECT_URI =  "http://localhost:3001/redirecturi";
    ...
    return (
       ...
       <div className={styles.header__title}>
        ...
        <button className={styles.KakaoBtn} ><p className={styles.kakaoBtn_title}> 카카오 로그인 / 회원가입</p> 
        ...
        <button className={styles.counselorBtn} onClick={()=>{ navigate('/counselor/login')}}>상담사 로그인</button>
        </>
    )
}
