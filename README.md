...
* 상담 예약 시엔 상담을 받고 싶은 주제를 선택하여 상담사를 확인 후 상세 프로필에서 상담사에 대한 더 자세한 내용을 확인할 수 있습니다.
* 상담사, 날짜, 시간을 모두 선택하여 예약을 완료합니다.

  ![reserveCounsel](/uploads/d15dec04c001e6d92767453e0c58088d/reserveCounsel.gif)
<br>

* 각각의 사용자에게 맞는 상담사 추천 서비스를 제공합니다.
* 평일과 주말로 구분된 전체 상담사 목록을 볼 수 있습니다.
